...
@BusinessEntityGenerator (entityname="TrainingSamples.BusinessLogik.CustomerWithReposition.CustomerBusinessEntity", type="TempTable") .
...
DEFINE {&ACCESS} TEMP-TABLE eCustomer{&SUFFIX} NO-UNDO {&REFERENCE-ONLY} &IF DEFINED (NO-BEFORE) EQ 0 &THEN BEFORE-TABLE eCustomerBefore{&SUFFIX} &ENDIF
    ...
    FIELD Country AS CHARACTER FORMAT "x(20)":U INITIAL "USA":U LABEL "Country":T
    ...
    FIELD CreditLimit AS DECIMAL FORMAT "->,>>>,>>9":U INITIAL "1500":U LABEL "Credit Limit":T
    FIELD Balance AS DECIMAL FORMAT "->,>>>,>>9.99":U INITIAL "0":U LABEL "Balance":T
